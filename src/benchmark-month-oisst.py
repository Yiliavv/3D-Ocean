...
def preload_dataset(seq_len: int):
    """一次性将所有数据从磁盘加载到内存"""
    print(f"[Preload] Loading ERA5 monthly data into memory (seq_len={seq_len})...")
...
def main():
    ...
    print("=" * 70)
    print("SST Model Benchmark - ERA5 Monthly (5 models x 2 epochs x 2 seq_len = 20 runs)")
    print("=" * 70)
    ...
    for i, exp in enumerate(EXPERIMENTS, 1):
        ...
        save_results(results, f"{PROJECT_PATH}/out/benchmark_era5_monthly.csv")
